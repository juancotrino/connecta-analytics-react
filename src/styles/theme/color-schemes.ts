...
import { california, kepple, neonBlue, nevada, redOrange, shakespeare, stormGrey, connectaPalette } from './colors';
...
export const colorSchemes = {
  ...
  light: {
    palette: {
      ...
      primary: {
        ...connectaPalette,
        light: connectaPalette[400],
        main: connectaPalette[500],
        dark: connectaPalette[600],
        contrastText: 'var(--mui-palette-common-white)',
      },
      secondary: {
        ...nevada,
